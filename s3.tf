...
resource "aws_s3_bucket_public_access_block" "creative-corners" {
...
#tfsec:ignore:aws-s3-enable-bucket-encryption
#tfsec:ignore:aws-s3-encryption-customer-key
resource "aws_s3_bucket" "samornbo_com" {
  provider = aws.us-east-1
  bucket   = "samornbo.com"
}

resource "aws_s3_bucket_public_access_block" "samornbo_com" {
  provider = aws.us-east-1
  bucket   = aws_s3_bucket.samornbo_com.id
...
#tfsec:ignore:aws-s3-enable-versioning 
resource "aws_s3_bucket_versioning" "samornbo_com" {
  provider = aws.us-east-1
  bucket   = aws_s3_bucket.samornbo_com.id
  versioning_configuration {
    status = "Suspended"
...
resource "aws_s3_bucket_acl" "samornbo_com" {
  provider = aws.us-east-1
  bucket   = aws_s3_bucket.samornbo_com.id
  acl      = "private"
}
